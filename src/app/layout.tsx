  ...
  return (
    <html lang="vi" className="h-full antialiased">
      <head>
        ...
        <script dangerouslySetInnerHTML={{
          __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-YDG28CY1G1');gtag('config','AW-16753907826');`
        }} />
        <script dangerouslySetInnerHTML={{
          __html: `!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init','1041137901594304');fbq('track','PageView');`
        }} />
        <script dangerouslySetInnerHTML={{
          __html: `var AD_LABEL='7665387772';document.addEventListener('click',function(e){var t=e.target.closest('a');if(!t)return;var h=t.getAttribute('href');if(!h)return;if(h.startsWith('tel:')||h.startsWith('https://zalo.me')){if(typeof fbq==='function')fbq('track','Contact');if(typeof gtag==='function'){gtag('event','contact_click',{event_category:'engagement',event_label:h});if(AD_LABEL)gtag('event','conversion',{send_to:'AW-16753907826/'+AD_LABEL})}}})`
        }} />
      </head>
      <body className="min-h-full flex flex-col bg-zinc-950 text-zinc-100">
        ...
        <noscript><img height="1" width="1" style={{display:"none"}} src="https://www.facebook.com/tr?id=1041137901594304&ev=PageView&noscript=1" /></noscript>
        {children}
      </body>
    </html>
  )
