  ...
  return (
    <html lang="vi" className="h-full antialiased">
      <head>
        ...
        <script dangerouslySetInnerHTML={{
          __html: `var AD_LABEL='';document.addEventListener('click',function(e){var t=e.target.closest('a');if(!t)return;var h=t.getAttribute('href');if(!h)return;if(h.startsWith('tel:')||h.startsWith('https://zalo.me')){if(typeof fbq==='function')fbq('track','Contact');if(typeof gtag==='function'){gtag('event','contact_click',{event_category:'engagement',event_label:h});if(AD_LABEL)gtag('event','conversion',{send_to:'AW-16753907826/'+AD_LABEL})}}})`
        }} />
      </head>
