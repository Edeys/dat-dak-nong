...
declare global { interface Window { dataLayer: any[]; AD_LABEL?: string; fbq?: (...args: any[]) => void; gtag?: (...args: any[]) => void } }
...
export default function LeadForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (typeof window !== "undefined") {
      ...
      if (window.gtag && window.AD_LABEL) {
        window.gtag("event", "conversion", { send_to: "AW-16753907826/" + window.AD_LABEL })
      }
    }
  }
