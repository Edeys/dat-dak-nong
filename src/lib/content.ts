...
export const heroContent = {
  ...
  subheadline: "Cà phê • Sầu riêng • Hồ tiêu — Có sẵn thu nhập hàng năm",
  description: "Cách QL28 chỉ 600m • Điện 3 pha • Nước suối quanh năm • Địa hình thoải",
  price: "Giá: 230 triệu/sào (~2.3 tỷ cho 19.445m² trên sổ)",
...
export const locationContent = {
  ...
  amenities: [
    ...
    { name: "Bệnh viện Đa khoa", distance: "~8 km", time: "10 phút", icon: "🏥", desc: "Bệnh viện tỉnh Đắk Nông" },
    { name: "QL28", distance: "600m", time: "1 phút", icon: "🛣️", desc: "Kết nối giao thông thuận tiện" },
    { name: "Sân bay Liên Khương", distance: "~120 km", time: "2 giờ", icon: "✈️", desc: "Sân bay quốc tế Lâm Đồng" },
